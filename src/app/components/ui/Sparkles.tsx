...
// Valeurs par défaut définies en dehors du composant pour éviter de nouvelles allocations à chaque rendu.
...
export const SparklesCore = (props: ParticlesProps) => {
    ...
    // Utilisez useMemo pour éviter un calcul coûteux sur chaque rendu
    const particleOptions = useMemo(() => ({
